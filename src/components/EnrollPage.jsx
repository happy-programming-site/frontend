  ...
  if (!course) {
    return (
      <div className={styles.notFound}>
        ...
        <Link to='/' className={styles.backLink}>← Back to courses</Link>
      </div>
    );
  }
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        ...
        <div className={styles.courseCard} style={{ "--line": course.line }}>
          ...
          {course.meta && (
            <p className={styles.courseMeta}>⚠️ {course.meta}</p>
          )}
          ...
          {course.slots.map((slot) => (
            ...
            >
              ...
              <div className={styles.radioCircle}>
                {selectedSlot === slot.id && <div className={styles.radioDot} />}
              </div>
          ...
          <div className={styles.row}>
            <div className={styles.field}>
              ...
              <input
                ...
                placeholder='Jane'
              />
              {errors.studentFirstName && <p className={styles.error}>{errors.studentFirstName}</p>}
            </div>
            <div className={styles.field}>
              ...
              <input
                ...
                placeholder='Smith'
              />
              {errors.studentLastName && <p className={styles.error}>{errors.studentLastName}</p>}
            </div>
          </div>
          <div className={styles.field}>
            ...
            {errors.studentGrade && <p className={styles.error}>{errors.studentGrade}</p>}
          </div>
        </div>
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.row}>
            <div className={styles.field}>
              ...
              />
              {errors.parentEmail && <p className={styles.error}>{errors.parentEmail}</p>}
            </div>
            <div className={styles.field}>
